<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="../viewcalendar/calendar.php"><i class="fa fa-calendar"></i> <span>Calendar</span></a></li>
            <li><a href="exam.php"><i class="fa fa-puzzle-piece"></i> <span>Exams</span></a></li>
            ...
            <li><a href="../viewattendance/attendance.php"><i class="fa fa-edit"></i> <span>Attendance</span></a></li>
        </ul>
    </section>
    <!-- /.sidebar -->
</aside>
