    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="active treeview">
                ...
                <ul class="treeview-menu">
                    <li class="active"><a href="registerteacher.php"><i class="fa fa-folder-open-o"></i> Register Teacher</a></li>
                    <li><a href="viewteacher.php"><i class="fa fa-folder-open-o"></i> View Teacher</a></li>
                    <li><a href="editteacher.php"><i class="fa fa-folder-open-o"></i> Edit Teacher</a></li>
                </ul>
            </li>
